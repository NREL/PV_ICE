...
skipcols=['Source']
mrktshr_cellsize = pd.read_csv(cwd+"/../../PV_DEMICE/baselines/SupportingMaterial/MarketShare_CellSize.csv",
...
scaled_marketshares.to_csv(cwd+'/../../PV_DEMICE/baselines/SupportingMaterial/output_scaledmrktshr_mcSi_mono.csv', index=True)
...
#print(df_cellperm2)
df_cellperm2.to_csv(cwd+'/../../PV_DEMICE/baselines/SupportingMaterial/output_cell_per_m2.csv', index=True)
...
df_Simass_percell.to_csv(cwd+'/../../PV_DEMICE/baselines/SupportingMaterial/output_si_g_per_cell.csv', index=True)
...
#print out to a csv
df_Simass_perm2.to_csv(cwd+'/../../PV_DEMICE/baselines/SupportingMaterial/output_si_g_per_m2.csv', index=True)
