...
fig1.update_layout(font=dict(size=25), height = 1000, width = 1000)
fig1.show()
...
#look into Julien's assumptions to see how he converts from MW to mass, look into this method
