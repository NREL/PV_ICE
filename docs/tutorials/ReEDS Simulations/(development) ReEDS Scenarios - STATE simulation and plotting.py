...
# ### Yearly and Cuumlative Tables 3 Sigs
...
obj.scenario[STATEs[0]].data.iloc[-1]
...
UScum['Waste_Module_Reference.Mod']
...
USyearly['Capacity_Reference.Mod'].head()
...
UScum['new_Installed_Capacity_[MW]Reference.Mod'].head()
